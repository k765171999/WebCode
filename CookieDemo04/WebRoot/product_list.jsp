...
<html>
	...
	<body>
		...
		<div class="row" style="width:1210px;margin:0 auto;">
			...
			<div class="col-md-2">
				<a href="ProductInfoServlet?id=1">
			...
			<div class="col-md-2">
				<a href="ProductInfoServlet?id=2">
			...
			<div class="col-md-2">
				<a href="ProductInfoServlet?id=3">
			...
			<div class="col-md-2">
				<a href="ProductInfoServlet?id=4">
			...
			<div class="col-md-2">
				<a href="ProductInfoServlet?id=5">
			...
			<div class="col-md-2">
				<a href="ProductInfoServlet?id=6">
		...
		<div style="width:1210px;margin:0 auto; padding: 0 9px;border: 1px solid #ddd;border-top: 2px solid #999;height: 246px;">
			...
			<div style="overflow: hidden;">
				...
				<h3><a href="ClearHistory">清除历史记录</a></h3><br>
		</div>
